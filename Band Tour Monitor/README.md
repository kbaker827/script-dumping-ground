...
Monitors concert tour dates for **Metallica**, **Green Day**, **Five Finger Death Punch**, **Taylor Swift**, **Nickelback**, **Godsmack**, **3 Doors Down**, **Aerosmith**, **Soundgarden**, **The Smashing Pumpkins**, **Staind**, **Counting Crows**, **Blink-182**, **Bush**, **Oasis**, **Sublime**, and **Marcy Playground** in **North Carolina** and sends alerts via Telegram.

## Features

- 🎸 Tracks Metallica, Green Day, Five Finger Death Punch, Taylor Swift, Nickelback, Godsmack, 3 Doors Down, Aerosmith, Soundgarden, The Smashing Pumpkins, Staind, Counting Crows, Blink-182, Bush, Oasis, Sublime, and Marcy Playground tour announcements
